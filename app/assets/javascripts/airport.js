...
require.define("/app/base.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var AirportView, Authentication, Backbone, BaseCollection, BaseModel, BaseView, Bus, Hb, PlaceHolderView, airportize, deferred, log, _,
  ...
  exports.PlaceHolderView = PlaceHolderView = (function(_super) {

    __extends(PlaceHolderView, _super);

    function PlaceHolderView(message) {
      this.message = message;
      this.setElement(Hb.empty.render({
...
require.define("/app/templates.js",function(require,module,exports,__dirname,__filename,process){// AUTOGENERATED by liz.js on Fri Jul 20 2012 21:47:39 GMT+0530 (IST). DO NOT EDIT.
var hogan = require('hogan.js');
exports.chat = (function(){var _t=new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<div class=\"empty-message\">Team Chat,<br/> Coming soon.</div>");return _.fl();;});return{_t:_t,render:function(){return _t.render.apply(_t,arguments)}};})();
exports.content = {};
...
exports.empty = (function(){var _t=new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<div class=\"empty-message\">");_.b(_.t(_.f("message",c,p,0)));_.b("</div>");return _.fl();;});return{_t:_t,render:function(){return _t.render.apply(_t,arguments)}};})();
...
exports.header.links = (function(){var _t=new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<a class=\"icon\" href=\"https://github.com/runway7/airport\" title=\"Feedback\">");_.b("\n" + i);_.b("        <i class=\"icon-phone\"></i>");_.b("\n" + i);_.b("    </a>");_.b("\n" + i);_.b("    <a class=\"icon\" href=\"/\" title=\"Settings\">");_.b("\n" + i);_.b("        <i class=\"icon-home\"></i>");_.b("\n" + i);_.b("    </a>    ");_.b("\n" + i);if(!_.s(_.f("authenticated",c,p,1),c,p,1,0,0,"")){_.b("    <a class=\"icon\" href=\"/\" title=\"Sign In\">");_.b("\n" + i);_.b("        <i class=\"icon-signin\"></i>");_.b("\n" + i);_.b("    </a>");_.b("\n");};if(_.s(_.f("authenticated",c,p,1),c,p,0,373,476,"{{ }}")){_.rs(c,p,function(c,p,_){_.b("    <a class=\"icon logout\" href=\"/\" title=\"Logout\">");_.b("\n" + i);_.b("        <i class=\"icon-signout\"></i>");_.b("\n" + i);_.b("    </a>");_.b("\n");});c.pop();}return _.fl();;});return{_t:_t,render:function(){return _t.render.apply(_t,arguments)}};})();
...
exports.issues.emptyMessage = (function(){var _t=new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("No Issues?");return _.fl();;});return{_t:_t,render:function(){return _t.render.apply(_t,arguments)}};})();
exports.issues.event = (function(){var _t=new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<div class=\"event\">");_.b("\n" + i);_.b("        <div class=\"issue-user\">            ");_.b("\n" + i);_.b("            <img class=\"avatar\" src=\"");_.b(_.v(_.d("actor.avatar_url",c,p,0)));_.b("\"/>            ");_.b("\n" + i);_.b("            <div class=\"info\">");_.b("\n" + i);_.b("                <span><a href=\"/");_.b(_.v(_.d("actor.login",c,p,0)));_.b("\">");_.b(_.v(_.d("actor.login",c,p,0)));_.b("</a> ");_.b(_.t(_.f("copy",c,p,0)));_.b(" <span class=\"age\">");_.b(_.v(_.f("timeOpened",c,p,0)));_.b("</span></span>");_.b("\n" + i);_.b("            </div>        ");_.b("\n" + i);_.b("        </div>        ");_.b("\n" + i);_.b("    </div>");return _.fl();;});return{_t:_t,render:function(){return _t.render.apply(_t,arguments)}};})();
...
require.define("/app/users.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var CurrentOrgMemberList, CurrentUser, Hb, MemberView, MembersView, User, UserInfoView, UserList, base, github, _,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
  ...
  exports.CurrentUser = CurrentUser = (function(_super) {
    ...
    function CurrentUser(bus) {
      ...
      this.bus.on('show:home', function() {
        return _this.load(github.currentUser().done(function(userData) {
...
require.define("/app/github.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var GITHUB_API_ENPOINT, auth, repoEvents, request, userEvents, _;
  ...
  request = function(opts) {
    ...
    if ((_ref4 = (_base = opts.headers)['Accept']) == null) {
  ...
  exports.repos = function(user) {
    return request({
      url: (auth.isCurrentUser(user) ? "/user/repos" : "/users/" + user + "/repos"),
      data: {
        sort: 'updated',
        direction: 'desc'
      }
...
require.define("/app/auth.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var getLogin, getToken, isCurrentUser, isLoggedIn, logout, set;

  exports.set = set = function(options) {
    ...
    return localStorage.setItem('login', options.login);
  };

  exports.getLogin = getLogin = function() {
    return localStorage.getItem('login');
  };

  exports.getToken = getToken = function() {
    return localStorage.getItem('token');
  };

  exports.isLoggedIn = isLoggedIn = function() {
    return !!(getToken() && getLogin());
  };

  exports.isCurrentUser = isCurrentUser = function(login) {
...
require.define("/app/issues.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var CommentView, CurrentIssue, CurrentIssueComments, CurrentIssueEvents, CurrentRepoIssueList, EventView, Hb, Issue, IssueComment, IssueCommentsView, IssueCreationView, IssueEvent, IssueEventsView, IssueInfoView, IssueListView, IssueSummaryView, IssueView, base, github, moment, _,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
  ...
  IssueCreationView = (function(_super) {

    __extends(IssueCreationView, _super);

    function IssueCreationView() {
      return IssueCreationView.__super__.constructor.apply(this, arguments);
    }
  ...
  exports.IssueListView = IssueListView = (function(_super) {
    ...
    function IssueListView(issueList) {
      ...
      this.showEmptyMessage(this.issueList, Hb.issues.emptyMessage.render());
    }
...
require.define("/app/header.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var Hb, HeaderPathElementView, HeaderPathView, HeaderView, auth, base,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    __slice = [].slice;
  ...
  exports.HeaderPathView = HeaderPathView = (function(_super) {
    ...
    function HeaderPathView(bus) {
      ...
      this.bus.on('show:home show:login', function(user) {
  ...
  exports.HeaderView = HeaderView = (function(_super) {
    ...
    function HeaderView(bus) {
      ...
      $.when(this.rendering).done(function() {
        return _this.$el.find('.links').append(Hb.header.links.render({
...
require.define("/app/routes.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var AirportRouter, Backbone, auth,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  exports.AirportRouter = AirportRouter = (function(_super) {
    ...
    AirportRouter.prototype.home = function() {
      ...
      return this.bus.trigger(auth.isLoggedIn() ? 'show:home' : 'show:login');
    };
...
require.define("/app/app.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var Backbone, activitiesView, airportView, auth, base, bus, chat, chatView, currentActivities, currentEvents, currentIssue, currentIssueComments, currentIssueEvents, currentIssues, currentMembers, currentRepo, currentRepoList, currentUser, dashboard, deferred, events, eventsView, github, header, headerView, hogan, intentionalBlankView, issueCommentsView, issueEventsView, issueInfoView, issueListView, issueSummaryView, issues, login, loginInfoView, loginView, membersView, metroView, options, repoInfoView, repoListView, repos, router, routes, userInfoView, users, _s;
