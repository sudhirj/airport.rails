...
require.define("/app/templates.js",function(require,module,exports,__dirname,__filename,process){// AUTOGENERATED by liz.js on Sat Jun 30 2012 00:24:56 GMT+0530 (IST). DO NOT EDIT.
...
exports.issues.emptyMessage = (function(){var _t=new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("No Issues?<br/><span class=\"new-issue action\">Create One!</span>");return _.fl();;});return{_t:_t,render:function(){return _t.render.apply(_t,arguments)}};})();
...
require.define("/app/auth.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var getLogin, getToken, isCurrentUser, isLoggedIn, set;
...
require.define("/app/issues.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  ...
  exports.IssueListView = IssueListView = (function(_super) {
    ...
    function IssueListView(issueList) {
      ...
      this.$el.on('click', '.new-issue', function(e) {
        return false;
      });
    }
